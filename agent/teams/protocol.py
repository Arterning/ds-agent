"""
Protocol state machine — request/response matching for shutdown & plan approval.

Each protocol request gets a unique id.  Responses are matched by id so they
cannot accidentally approve the wrong request.
"""
