"""
Permission hook — runs before every tool dispatch.

Checks:
- Deny-list patterns (rm -rf /, sudo, shutdown, etc.)
- Destructive commands require user confirmation
- File paths must stay inside workspace
- MCP deploy tools require user confirmation
"""
